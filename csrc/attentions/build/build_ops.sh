...
function build_ops(){
    ...
    rm -rf vendors
    source ${current_script_dir}/build_ascendc_ops.sh -n 'laser_attention;ada_block_sparse_attention;sparse_block_estimate;hc_pre' -c 'ascend910;ascend910b;ascend910_93;ascend950'
